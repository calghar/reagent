...
def _print_scan_report(report: ScanReport) -> None:
    ...
    """
    from agentguard.security.scanner import Severity
...
def audit_cmd(repo: Path) -> None:
    ...
    from agentguard.security.scanner import scan_directory
...
def integrity_check() -> None:
    ...
    from agentguard.security.governance import run_integrity_check_with_logging
...
def integrity_report() -> None:
    ...
    from agentguard.security.governance import check_integrity
