...
from agentguard.cli._helpers import _load_config
...
def instincts_list() -> None:
    ...
    from agentguard.llm.instincts import InstinctStore, ensure_bundled
...
def instincts_extract(repo: Path) -> None:
    ...
    from agentguard.telemetry.profiler import profile_repo
...
def instincts_prune(max_age: int, min_confidence: float) -> None:
    ...
    from agentguard.llm.instincts import InstinctStore, prune_stale
...
def instincts_import(path: Path) -> None:
    ...
    from agentguard.llm.instincts import InstinctStore, import_instincts
...
def instincts_export(path: Path, min_confidence: float) -> None:
    ...
    from agentguard.llm.instincts import InstinctStore, export_instincts
