...
def profile_repo(
    ...
    Args:
        ...
        config: Optional AgentGuardConfig to control profiling behaviour.
...
def save_workflow_model(
    ...
    Args:
        ...
        output_dir: Directory for output. Defaults to ~/.agentguard/workflows/.

    Returns:
        Path to the saved YAML file.
    """
    if output_dir is None:
        output_dir = Path.home() / ".agentguard" / "workflows"
