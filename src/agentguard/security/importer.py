...
from agentguard.security.scanner import ScanReport, scan_directory
...
def fetch_to_staging(
    ...
    Args:
        ...
        staging_root: Root directory for staging. Defaults to ~/.agentguard/staging/.
    ...
    if staging_root is None:
        staging_root = Path.home() / ".agentguard" / "staging"
