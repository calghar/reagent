...
class RepoProfile(BaseModel):
    ...
    def save(self, output_dir: Path | None = None) -> Path:
        ...
        Args:
            output_dir: Override output directory. Defaults to ~/.agentguard/repos/.

        Returns:
            Path to the saved profile file.
        """
        dest = output_dir or (Path.home() / ".agentguard" / "repos")
    ...
    def load_profile(
        ...
        """
        directory = profiles_dir or (Path.home() / ".agentguard" / "repos")
