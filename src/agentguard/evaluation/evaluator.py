...
from agentguard.security.scanner import scan_file
...
def evaluate_repo(
    ...
    Args:
        ...
        config: AgentGuard configuration.
    ...
    config = config or AgentGuardConfig.load()
    ...
    if not entries:
        from agentguard.core.inventory import scan_repo
