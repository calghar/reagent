---
name: go-backend
description: Use this agent for implementing Go code in the dtguard project — CLI commands (Cobra), resource handlers, attestation/signing, scanner rules, shield enforcer, DT API client, and OTel telemetry. Knows the dtctl alignment constraints. Use for any Go implementation work under cmd/ or internal/.
model: opus
skills:
  - architecture
  - testing
