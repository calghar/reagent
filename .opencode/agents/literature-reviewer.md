---
description: >-
  Systematically surveys a cloud native security topic. Searches arXiv, USENIX,
  IEEE, ACM, and GitHub. Returns a categorized paper catalog with gap analysis.
  Use when starting a new research project or writing related work.
mode: subagent
model: sonnet
permission:
  websearch: allow
