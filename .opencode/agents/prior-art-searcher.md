---
description: >-
  Searches patents and academic literature to identify prior art for a potential
  patent application. Returns a prior art landscape with novelty gap analysis.
  Use before drafting patent claims.
mode: subagent
model: sonnet
permission:
  websearch: allow
