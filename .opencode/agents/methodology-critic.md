---
description: >-
  Adversarial review of a research methodology or experimental design. Checks
  for threats to validity, missing baselines, and metric weaknesses. Use after
  defining methodology but before starting experiments.
mode: subagent
model: opus
permission:
  websearch: allow
